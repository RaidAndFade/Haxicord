...
class DateUtils {
    ...
    public static function fromISO8601(iso:String):Date{
        ...
        var month = Std.parseInt(isoreg.matched(2));
        var day = Std.parseInt(isoreg.matched(3));
        var hour = Std.parseInt(isoreg.matched(8));
        var minute = Std.parseInt(isoreg.matched(9));
        var second = Std.parseInt(isoreg.matched(10));
        var fraction = Std.parseFloat("0"+isoreg.matched(11));
